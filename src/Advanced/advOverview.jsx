...
export default function OverviewAdv() {
  ...
  return (
    ...
    >
      ...
      <img src='https://potomac.edu/wp-content/uploads/2020/12/benefits-of-coding-e1606911064541.jpg' style={{width:'700px',marginLeft:'100px',marginTop:'10px'}}></img>
